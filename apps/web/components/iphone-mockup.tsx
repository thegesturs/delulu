  ...
  return (
    <div className="relative mx-auto h-[600px] w-[300px] md:h-[680px] md:w-[340px]">
      ...
      <div className="absolute inset-0 rounded-[50px] border-[14px] border-black bg-black shadow-xl">
        {/* Dynamic Island */}
        <div className="-translate-x-1/2 absolute top-[0.5rem] left-1/2 z-10 h-[1.8rem] w-[6rem] rounded-full bg-black">
          <div className="-translate-y-1/2 absolute top-1/2 right-3 h-[0.6rem] w-[0.6rem] rounded-full bg-[#1a1a1a] ring-[#2a2a2a] ring-[1.5px]">
      ...
      {/* Side Buttons */}
      <div className="-right-[2px] absolute top-[170px] h-12 w-[3px] rounded-l-lg bg-black" />
      <div className="-left-[2px] absolute top-[120px] h-12 w-[3px] rounded-r-lg bg-black" />
      <div className="-left-[2px] absolute top-[170px] h-14 w-[3px] rounded-r-lg bg-black" />
    </div>
  );
};
