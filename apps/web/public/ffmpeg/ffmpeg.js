// biome-ignore-all lint: generated ffmpeg.wasm UMD bundle.
!((e, t) => {
    ...
    class i {
      ...
      #i = ({ type: e, data: t }, s = [], o) =>
        this.#e
          ...
          : Promise.reject(a);
      on(e, t) {
        e === "log" ? this.#r.push(t) : e === "progress" && this.#a.push(t);
      }
      off(e, t) {
        e === "log"
          ? (this.#r = this.#r.filter((e) => e !== t))
          : e === "progress" && (this.#a = this.#a.filter((e) => e !== t));
      }
