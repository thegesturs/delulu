  ...
  return (
    <div className="space-y-7">
      <div className="space-y-3">
        <p className="inline-flex items-center gap-1.5 font-medium text-emerald-700 text-sm dark:text-emerald-400">
      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {accounts.map((account) => {
            ...
            return (
              <div
                className="flex min-w-0 items-center gap-3 rounded-xl bg-muted/25 p-3.5 ring-1 ring-border/70"
                key={account.id}
              >
