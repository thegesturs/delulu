/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: ae4cd0304850fbc35171992779c792a2)
// Runtime types generated with workerd@1.20250617.0 2024-12-30 enable_request_signal,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DELULU_FACEBOOK_PAGES: KVNamespace;
		DELULU_ARTICLES_KV: KVNamespace;
		MAINTENANCE_MODE: "false";
		NEXT_PUBLIC_API_URL: "https://api.delulu.social" | "https://api-next.delulu.social";
