...
Database-backed integration tests require `DATABASE_URL` and the local migrations. See [API runtime](/development/api-runtime/) for worker secrets and deployment bindings.
