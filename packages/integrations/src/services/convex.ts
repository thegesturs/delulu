...
import { type IntegrationError, networkError } from "../errors";
 ...
 */
export class ConvexClient extends Context.Tag("@delulu/integrations/ConvexClient")<
  ConvexClient,
  {
    readonly getSocialProviderWithDecryptedTokens: (
      id: string
    ) => Effect.Effect<SocialProviderTokens | null, IntegrationError>;
